...
class lib_test extends \advanced_testcase {
     ...
     * @return void
     */
    public function test_wordle_view() {
        global $CFG;
        ...
        $moodleurl = new \moodle_url('/mod/wordle/view.php', array('id' => $cm->id));
    ...
    public function test_wordle_core_calendar_provide_event_action() {
        $this->resetAfterTest();
        $this->setAdminUser();
        ...
        $event = $this->create_action_event($course->id, $wordle->id,
        ...
        $actionevent = mod_wordle_core_calendar_provide_event_action($event, $factory);
    ...
    public function test_wordle_core_calendar_provide_event_action_already_completed() {
        global $CFG;
    ...
    /**
     * Test mod_wordle_core_calendar_provide_event_action with user override
     */
    public function test_wordle_core_calendar_provide_event_action_user_override() {
        global $CFG, $USER;
        ...
        // Decorate action event.
        $actionevent = mod_wordle_core_calendar_provide_event_action($event, $factory, $USER->id);

        // Decorate action with a userid override.
        $actionevent2 = mod_wordle_core_calendar_provide_event_action($event, $factory, $user->id);
